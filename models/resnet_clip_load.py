...
class ResNet_Clip(nn.Module):
    ...
    def __init__(self, model_name, num_classes, embed_dim, **kwargs):
        ...
        self.model, self.preprocess = clip.load(self.model_name, download_root='/benchmarking_backbone/checkpoints/')
...
@register_model
def resnet50_clip_load(pretrained=False, num_classes=1000, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def resnet101_clip_load(pretrained=False, num_classes=1000, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def resnet50_4_clip_load(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def resnet50_16_clip_load(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def resnet50_64_clip_load(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
