...
@register_model
def vit_small_patch16_224_augreg_in1k(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """ ViT-Small (ViT-S/16)
...
@register_model
def vit_small_patch16_224_augreg_in21k_ft_in1k(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """ ViT-Small (ViT-S/16)
    NOTE I've replaced my previous 'small' model definition and weights with the small variant from the DeiT paper
    """
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, drop_path_rate=0.1, **kwargs)
...
@register_model
def vit_base_patch16_224_augreg_in1k(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def vit_base_patch16_224_augreg_in21k_ft_in1k(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, drop_path_rate=0.1, **kwargs)
...
@register_model
def vit_base_patch16_224_clip_laion2b(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    """
    model_kwargs = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, pre_norm=True, drop_path_rate=0.1, norm_layer=nn.LayerNorm, **kwargs)
    model = _create_vision_transformer('vit_base_patch16_224_clip_laion2b', pretrained=pretrained, **model_kwargs)
    return model


@register_model
def vit_large_patch16_224_augreg_in21k_ft_in1k(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def vit_large_patch14_224_clip_laion2b(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """ ViT-Base (ViT-L/14) from original paper (https://arxiv.org/abs/2010.11929).
    """
    model_kwargs = dict(
        patch_size=14, embed_dim=1024, depth=24, num_heads=16, pre_norm=True, drop_path_rate=0.1, norm_layer=nn.LayerNorm, **kwargs)
