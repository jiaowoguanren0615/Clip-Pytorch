...
def load_model(model_name):
    if not os.path.exists('./benchmarking_backbone/checkpoints'):
        os.makedirs('./benchmarking_backbone/checkpoints', exist_ok=True)

    model, preprocess = clip.load(model_name, download_root='/benchmarking_backbone/checkpoints/')
...
@register_model
def resnet50_clip(pretrained=False, image_res=224, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    vision_layers, vision_width, image_resolution, state_dict = load_model('RN50')

    if image_res is not None:
        image_resolution = image_res

    model = ResNet_Clip(image_resolution=image_resolution, vision_layers=vision_layers, vision_width=vision_width,
                        embed_dim=1024, drop_path_rate=0.1, **kwargs)
...
@register_model
def resnet101_clip(pretrained=False, image_res=224, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    ...
    model = ResNet_Clip(image_resolution=image_resolution, vision_layers=vision_layers, vision_width=vision_width,
                        embed_dim=512, drop_path_rate=0.1, **kwargs)
...
@register_model
def resnet50_4_clip(pretrained=False, image_res=288, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    ...
    model = ResNet_Clip(image_resolution=image_resolution, vision_layers=vision_layers, vision_width=vision_width,
                        embed_dim=640, drop_path_rate=0.1, **kwargs)
...
@register_model
def resnet50_16_clip(pretrained=False, image_res=384, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    ...
    model = ResNet_Clip(image_resolution=image_resolution, vision_layers=vision_layers, vision_width=vision_width,
                        embed_dim=768, drop_path_rate=0.1, **kwargs)
...
@register_model
def resnet50_64_clip(pretrained=False, image_res=448, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
