...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'Clip training and evaluation script', add_help=False)
    ...
    parser.add_argument('--model', default='resnet50_clip', type=str, metavar='MODEL',
                        choices=['resnet50_clip', 'resnet50_16_clip', 'resnet50_64_clip', 'resnet101_clip', 'resnet50_4_clip',
                                 'vit_base_patch16_224_clip_laion2b', 'vit_large_patch14_224_clip_laion2b', 'vit_base_patch16_224_augreg_in1k',
                                 'vit_base_patch16_224_augreg_in21k_ft_in1k', 'vit_small_patch16_224_augreg_in1k',
                                 'vit_small_patch16_224_augreg_in21k_ft_in1k', 'vit_large_patch16_224_augreg_in21k_ft_in1k'],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'Clip training and evaluation script', parents=[get_args_parser()])
